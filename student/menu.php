...
<body>
    <div class="dashboard_container">
        <div class="main">
            ...
            <div class="hr"></div>
            <ul>
                <li><i class="fa-solid fa-clock-rotate-left" style="color: #ffffff;"></i>&nbsp;<a href="./index.php" class="ul-el" aria-expanded="false">History</a></li>
                <li><i class="fa-solid fa-user" style="color: #ffffff;"></i>&nbsp;<a href="./profile.php" class="ul-el" aria-expanded="false">Profile</a></li>
            </ul>
        </div>
    </div>
