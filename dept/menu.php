...
<body>
    <div class="dashboard_container">
        <div class="main">
            <h2 class="admin-heading"><?php echo $_SESSION['name']; ?> &nbsp;<i class="fa fa-solid fa-user fa-sm" style="color:#fff"></i></h2>
            <div class="hr"></div>
            <ul>
                <li><i class="fa-solid fa-flag" style="color: #ffffff;"></i>&nbsp;<a href="./index.php" class="ul-el" aria-expanded="false">Reports</a></li>
                <li><i class="fa-solid fa-users" style="color: #ffffff;"></i>&nbsp;<a href="./approval.php" class="ul-el" aria-expanded="false">Pending Approvals</a></li>
